    ...
    view! {
        <div class="credits-container fade-in">
            ...
            <style>
                ...
                .balance-card .card-body { padding: var(--s-12); display: flex; flex-direction: column; height: 100%; gap: var(--s-8); }
                .balance-meta { display: flex; align-items: center; gap: var(--s-3); color: hsl(var(--accent)); font-weight: 800; font-size: 0.625rem; letter-spacing: 0.15em; }
                .balance-main { padding-bottom: var(--s-8); border-bottom: 1px solid hsl(var(--border)); display: flex; align-items: baseline; gap: var(--s-4); }
                .credits-count { font-size: clamp(4rem, 10vw, 6rem); font-weight: 800; line-height: 0.9; letter-spacing: -0.05em; font-family: var(--font-mono); color: hsl(var(--text)); }
                ...
                .mini-stat-header { padding: var(--s-4) var(--s-6); border-bottom: 1px solid hsl(var(--border)); display: flex; align-items: center; gap: var(--s-3); font-size: 0.625rem; font-weight: 800; color: hsl(var(--text-dim)); letter-spacing: 0.1em; }
                ...
                .mini-stat-item .label { font-size: 0.625rem; font-weight: 800; color: hsl(var(--text-dim)); letter-spacing: 0.05em; }
                .mini-stat-item .value { font-size: 0.8125rem; font-weight: 700; font-family: var(--font-mono); color: hsl(var(--text)); }
                ...
                .pricing-row .label { color: hsl(var(--text-dim)); text-transform: uppercase; letter-spacing: 0.05em; font-size: 0.625rem; }
                .pricing-row .value { color: hsl(var(--accent)); }
                
                .security-note { margin-top: var(--s-16); color: hsl(var(--text-dim)); font-size: 0.625rem; font-weight: 700; letter-spacing: 0.05em; display: flex; align-items: center; gap: var(--s-4); justify-content: center; opacity: 0.8; text-transform: uppercase; }
